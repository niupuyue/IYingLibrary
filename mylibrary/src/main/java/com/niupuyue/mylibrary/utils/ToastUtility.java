...
public class ToastUtility {
    ...
    private static void show(Context context, final int resId, final int duration) {
        try {
    ...
    private static void show(Context context, final int resId, final int duration, final Object... args) {
        try {
            CharSequence text = context.getResources().getText(resId);
    ...
    private static void show(final Context context, final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                iToast = ToastFactory.makeToast(context, text, duration);
    ...
    private static void show(final Context context, final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                iToast = ToastFactory.newToast(context);
                iToast.setView(view);
